...
// GetApplicationNamesForEndpoints mocks base method.
func (m *MockState) GetApplicationNamesForEndpoints(arg0 context.Context, arg1 []string) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetApplicationNamesForEndpoints", arg0, arg1)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetApplicationNamesForEndpoints indicates an expected call of GetApplicationNamesForEndpoints.
func (mr *MockStateMockRecorder) GetApplicationNamesForEndpoints(arg0, arg1 any) *MockStateGetApplicationNamesForEndpointsCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetApplicationNamesForEndpoints", reflect.TypeOf((*MockState)(nil).GetApplicationNamesForEndpoints), arg0, arg1)
	return &MockStateGetApplicationNamesForEndpointsCall{Call: call}
}

// MockStateGetApplicationNamesForEndpointsCall wrap *gomock.Call
type MockStateGetApplicationNamesForEndpointsCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockStateGetApplicationNamesForEndpointsCall) Return(arg0 []string, arg1 error) *MockStateGetApplicationNamesForEndpointsCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockStateGetApplicationNamesForEndpointsCall) Do(f func(context.Context, []string) ([]string, error)) *MockStateGetApplicationNamesForEndpointsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockStateGetApplicationNamesForEndpointsCall) DoAndReturn(f func(context.Context, []string) ([]string, error)) *MockStateGetApplicationNamesForEndpointsCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
